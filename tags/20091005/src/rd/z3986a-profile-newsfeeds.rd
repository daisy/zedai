...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <div class="intro">
  <p>The Z39.86-2010 Newsfeed Aggregator Profile is intended to serve as an XML republishing format
   for syndicated web content, primarily <strong>news</strong>.</p>

  <p>The profile intends to capture input sources served in formats such as NewsML, Atom, NITF and
   RSS in a single format.</p>

  <p>The Profile has been designed to address the following contexts:</p>

  <ul>
   <li>Newspaper and Magazine vendors wanting to supply an entire publication in a light-weight XML
    grammar.</li>
   <li>Newspaper and Magazine vendors wanting to supply a single article, or a collection of
    articles from a publication in a light-weight XML grammar.</li>
   <li>Newspaper and Magazine vendors wanting to supply a single article, or a collection of
    articles from different publications in a light-weight XML grammar.</li>
   <li>Organisations wanting to convert all their incoming electronic feeds into a light-weight XML
    grammar.</li>
   <li>Organisations wanting to aggregate individual articles into one or more publications using a
    light-weight XML grammar.</li>
  </ul>
