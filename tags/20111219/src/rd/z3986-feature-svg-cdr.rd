...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:xi="http://www.w3.org/2001/XInclude">
  ...
  <div class="intro">
    <p>The Z39.86 SVG CDR (Compound Document by Reference) feature enables the use of SVG,
      referenced as external documents via the <code><a href="#z3986.object.module"
  ...
  <div class="normative-top">
    <div class="rd-section" id="content-reqs">
      ...
      <p>The <code>object</code> elements that carry the SVG document references must contain a
        textual fallback, as defined in the <a href="#z3986.object.module">object module</a>. <!--<span
      ...
      <p>The <code>object</code> elements that carry the SVG document references should contain at
        least one fallback using the image formats defined in <a href="#z3986.srctype.attrib">core
          image types</a>.</p>
