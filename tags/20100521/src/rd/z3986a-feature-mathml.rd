...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:xi="http://www.w3.org/2001/XInclude">
  ...
  <div class="intro">
    <p> The Z39.86 MathML Feature defines the W3C <a href="http://www.w3.org/TR/MathML3/"
        >Mathematical Markup Language (MathML) Version 3.0</a> as a feature for use in Z39.86-AI
      Profiles.</p>
    <p>Each element contributed by this feature inherits the corresponding semantics as defined by
    MathML 3.</p>
    
    <p class="ednote">REMARK: <a href="http://code.google.com/p/zednext/issues/detail?id=105">Issue 105</a></p>
  </div>
  ...
  <div class="normative-top">
    <div class="rd-section">
          ...
          <dl>
            ...
            <dd>
              <p> When providing images as alternate representations to MathML markup, the image
                content types used must not be other than those globally allowed by the Z39.86-AI
                profile. Concretely, this means that image references appearing on or inside a
                  ...
                  <code>srctype</code> attribute on the <a href="#z3986.object.module">object</a>
              ...
              <dl>
                ...
                <dd>
                  <p>Documents must use and processing agents must recognize the string
                      <code>Z39.86-AI</code> as the <code>encoding</code> identifier for this
                    content type. </p>
                  <p>The XML content inside an <code>annotation-xml</code> element using the
                      <code>Z39.86-AI</code> encoding is restricted to elements from the <a
                      href="#coreNamespace">Z39.86-AI Core namespace</a>, and elements in other
                    ...
                    element that declares the <code>Z39.86-AI</code> content type. Use of elements
                    from other Z39-86-AI features is discouraged.</p>
                </dd>
              </dl>
      ...
      <p> This features overrides the following attribute contributions from the Z39.86-AI <a
          href="#z3986.global.attrib">Global attributes</a> class: </p>
      <ul>
        ...
        <li>The Z39.86-AI-global <code>meta</code> and <code>i18n</code> attribute classes are 
