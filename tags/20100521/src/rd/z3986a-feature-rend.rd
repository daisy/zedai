...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:xi="http://www.w3.org/2001/XInclude">
	...
	<div id="public-components">
		<ul>
			<li><code><a href="#z3986.rend.attrib"/></code></li>
			<li><code><a href="#z3986.rend.symbol.attrib"/></code></li>
			<li><code><a href="#z3986.rend.indent.attrib"/></code></li>
			<li><code><a href="#z3986.rend.list.ordered.prefix.attrib"/></code> (ordered <code>list</code>)</li>
			<li><code><a href="#z3986.rend.list.unordered.prefix.attrib"/></code>(unordered <code>list</code>)</li>
			<li><code><a href="#z3986.rend.list.item.prefix.attrib"/></code>(list <code>item</code>)</li>
			<li><code><a href="#z3986.rend.note.prefix.attrib"/></code> (<code>note</code>)</li>			
		</ul>
	</div>
