...
<xsl:stylesheet exclude-result-prefixes="xs rng xd dcterms z rdf zrng zsd a x sch" version="2.0"
	...
	<xsl:template match="datatype-with-RDF/rdf:RDF" mode="ecm-display" />
	...
	<xsl:template match="rdf:RDF" mode="ecm-display-rdf">
		<div class="rdf">
	...
	<xsl:template match="dcterms:description" mode="ecm-display-rdf">
		<xsl:apply-templates mode="ecm-display-rdf" />
	</xsl:template>
