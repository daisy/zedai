...
public class RNGDocument extends Document {
	...
	/**
	 * Get those rng:element descendants in this document that has rdf:RDF as a firstChild.
	 */
	public List<RNGElementElement> getRNGElements(boolean onlyWithRDF) throws Exception {				
	 ...
	 * Get those rng:element descendants in this document that has rdf:RDF as a firstChild.
	 */
	public List<RNGAttributeElement> getRNGAttributes(boolean onlyWithRDF) throws Exception {				
	...
	/**
	 * Get those rng:define descendants in this document that has rdf:RDF as a firstChild.
	 */
	public List<RNGDefineElement> getRNGDefines(boolean onlyWithRDF) throws Exception {				
	...
	/**
	 * Get all rng namespace element children of this RNGDocument that has an RDF child as a firstchild.
