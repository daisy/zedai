...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="body">
      <body>
		...
		<div class="alert">
			<dl>
				<dt>21st of May 2010</dt>
				<dd>
					<p>Public review draft of <em>Z39.86-2011 Part A - Authoring and Interchange Framework</em>.</p>
		...
		<div>
        	...
        	<ul>
        	  ...
        	  <li><a href="{$ai-primername}">Primer</a></li>
          	</ul>
		...
		<div>
			...
			<p><em>First public draft expected in October 2010.</em></p>
			<!--
        	<ul>
