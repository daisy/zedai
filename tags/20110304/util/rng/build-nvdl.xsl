...
<rules startMode="document">
	...
	<mode name="document">
		<namespace ns="http://www.daisy.org/ns/z3986/authoring/">
			<validate schema="z3986a-{$profile}-single.rng" useMode="addNS"/>
			<validate schema="z3986a-{$profile}.sch" useMode="addNS"/>
		</namespace>
	</mode>
