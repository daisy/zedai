...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="nvdl-link">./resources/z3986a-<xsl:value-of select="$machinename"
	/>.nvdl</xsl:variable>
	
	<xsl:template match="x:html">

		<html prefix="rd: http://www.daisy.org/z3986/2011/vocab/resourcedirectory/# dcterms: http://purl.org/dc/terms/"
			lang="en-US"
			xml:lang="en-US">
			<head>
	...
	<xsl:template name="doIdentityURI">
		<div class="rd-section">
			<h3>Identity URI</h3>
			<p id="identity-uri"> The canonical identity URI of this version of the 
				<xsl:value-of select="$type"/> is:<br/><br/>
	...
	<xsl:template name="doVersionInfo">
		<div class="rd-section">
			...
			<xsl:variable name="recURI">http://www.daisy.org/z3986/2011/auth/<xsl:value-of select="$type"/>s/<xsl:value-of select="$machinename"/>/current/</xsl:variable>
	...
	<xsl:template name="doSpecRef">
		<div class="rd-section">
			...
			<p id="spec-ref"> This version of the <xsl:value-of select="$type"/> 
				is compliant with the <a href="../../../../Z3986-2011A.html" rel="rd:specification-compliance">Z3986-2011
	...
	<xsl:template name="doDefaultVocab">
		<xsl:if test="boolean($default-vocab-uri) and contains($type,'profile')">
			<div class="rd-section" id="default-rdfa-profile">
				<h3>Default RDFa profile</h3>
				<!--
				...
				<xsl:variable name="vocab-profile-uri">
					<xsl:text>http://www.daisy.org/z3986/2011/vocab/profiles/</xsl:text>
					<xsl:choose>
				...
				<p> The URI of the default RDFa profile is:<br/><br/>
					<code rel="rd:z3986-rdfa-profile">
						<xsl:value-of select="$vocab-profile-uri"/>
					</code>
				</p>
				<p> Refer to the <a href="{$vocab-profile-uri}">profile document</a> at this location for additional 
