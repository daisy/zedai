...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="body">
      <body>
		...
		<div class="alert">
			<dl>
				<dt>4th of March 2011</dt>
				<dd>
					<p>Draft Specification for Test Use — <em>Z39.86-2011 Part A - Authoring and Interchange Framework</em>.</p>
		...
		<div>
        	<h2 id="vocab">Z39.86-2011 RDF Vocabularies</h2>
