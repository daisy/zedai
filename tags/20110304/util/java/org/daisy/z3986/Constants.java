...
public class Constants {
	...
	public static final String ZEDAI_DOCBOOK_SPEC_TEMP_PATH = "/temp/spec-temp/Z3986-2011A.xml";
	public static final String ZEDDIST_DOCBOOK_SPEC_TEMP_PATH = "/temp/spec-temp/Z3986-2011B.xml";
	...
	public static final String ZEDNEXT_WWW_BASE = "http://www.daisy.org/z3986/2011/";
	public static final String ZEDAI_WWW_SPEC_FILENAME = "Z3986-2011A.html";
	public static final String ZEDAI_WWW_SPEC_PATH = ZEDNEXT_WWW_BASE + ZEDAI_WWW_SPEC_FILENAME;
	public static final String ZEDAI_WWW_CMP_PATH = ZEDNEXT_WWW_BASE + "auth/cm/Z3986-2011A-CM.html";
