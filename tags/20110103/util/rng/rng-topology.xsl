...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<!-- CSS -->
	<xsl:variable name="CSS" as="xs:string"> /* SchemaDoc.css */ body { font-family:verdana,arial,
		helvetica, sans-serif; margin:2% 8% 5% 6%; } body.pattern h2 { font-size:100%;
		display:inline; } div.driver-filename {font-size:smaller; color:rgb(90,90,0);
		background-color:rgb(240,240,240); border:1pt solid rgb(90,90,0); padding:2pt; }
		span.filename { font-family:monospace; color:rgb(90,90,0); } span.filenumber {
		margin-right:2em; } a { text-decoration:none; } div.driver-filename { font-family:monospace;
		font-size:large; } div.menu-buttons { text-align:center; } div.menu-buttons a {
		font-variant:small-caps; display:block; font-size:xx-large;
		background-color:rgb(220,220,240); margin:1em 20% 1em 20%; color:rgb(60,0,0); border:4pt
		solid rgb(220,220,240); } div.menu-buttons a:hover {border:outset;color:rgb(110,0,0);} /*
		Patterns and elements */ /*body.pattern h2,body.element h2 { font-size:100%; float:left; }*/
		a.p-local-toc, a.e-local-toc, div.pattern-toc div, div.element-toc div {
		display:inline-block; width:20pt; background-color:rgb(40,40,155); text-align:center;
		border:1pt solid rgb(170,170,250); color:rgb(250,250,250); padding:3pt; } a.p-local-toc,
		a.e-local-toc {margin-right:2mm;} div.pattern-toc div, div.element-toc div { margin-top:1em;
		margin-left:-25pt; } div.pattern-toc a, div.element-toc a { display:inline-block;
		color:rgb(180,0,0); background-color:rgb(240,240,220); padding:2pt 5pt 2pt 5pt; margin:2pt
		1pt 0 0; text-align:center; border:1pt solid rgb(170,170,200); } div.named-pattern,
		div.element { border:1pt solid rgb(240,240,240); margin-bottom:1em; padding:1mm;
		background-color:rgb(250,250,250); } div.rng { font-family:monospace; color:rgb(120,20,60);
		margin-left:1em; } table.pattern-info, table.element-info { width:100%; font-size:small;
		margin-bottom:0.5em; border-collapse:collapse; } table.pattern-info td, table.element-info
		td { background-color:rgb(0,0,90); color:rgb(255,255,234); padding-right:2em; }
		table.pattern-info td.lbl { font-weight:bold; } /* Fileset */ div.schema-fileset {
		font-size:small; } div.include { /*border:1pt solid red;*/ padding-left:3em;
		margin-bottom:0.5em; } div.file { /*border:1pt dashed green;*/ margin-bottom:1mm; }
		div.include-info { margin-left:3em; margin-bottom:1mm; } </xsl:variable>
