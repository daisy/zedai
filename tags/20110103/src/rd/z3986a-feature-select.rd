  ...
  <div class="normative-bottom">
    ...
    <div class="rd-section" id="prefix-decl">
      ...
      <p>
        ...
        <code>http://www.daisy.org/z3986/2011/auth/features/select/functionSets/#targetFunctionSet</code>:</p>
      <pre xml:space="preserve"><![CDATA[
<head xmlns:res="http://www.daisy.org/z3986/2011/vocab/resourcedirectory/#">
  <meta about="http://www.daisy.org/z3986/2011/auth/features/select/functionSets/#targetFunctionSet" 
...
ncname := [A-Za-z][A-Za-z0-9_]*
  ...
  <div id='public-components'>
    <ul>
      <li><code><a href="#z3986.select.phrase"></a></code> (Phrase variant)</li>
      <li><code><a href="#z3986.select.block"></a></code> (Block variant)</li>
      <li><code><a href="#z3986.select.selid.attrib"></a></code></li>
    </ul>  
  </div>
