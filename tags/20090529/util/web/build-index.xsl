...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="body">
      <body>
		...
		<div class="alert">
		  <p>29 May 2009: First public working draft of 
		  ...
		  <p>Please read the working groups 
		    <a href="http://www.daisy.org/zw/ZedAI_Iteration3_Report">current iteration report</a> 
		  ...
		  <p>Expect repeated updates in this area until November 2009.</p>
		</div>
