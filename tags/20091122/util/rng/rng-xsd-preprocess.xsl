...
<xsl:stylesheet version="2.0"
	...
	xmlns:xsdr="http://www.daisy.org/ns/rng-preprocess/xsd"
	...
	<!--   Example: <define name="z3986.section.content" 
	  xsdr:replace="z3986.section.content.xsd">  -->

	<xsl:template match="//define[@xsdr:replace]">
	  ...
	  <xsl:element name="define">
	    ...
	    <xsl:variable name="target" select="./@xsdr:replace" />
