  ...
  <div class="normative-bottom">
      ...
      <dl>
        ...
        <dd>
          <p>
            ...
            not. The expression appears as the value of the <a href="#z3998.expr.attrib"><code
              >expr</code></a> attribute on the <a href="#z3998.when.block"><code>when</code></a> 
            element.
          </p> 
    ...
    <div class="rd-section">
      ...
      <p id="feature-ns">The namespace of all members of the Content Selection feature element set
        is <code>http://www.daisy.org/ns/z3998/authoring/features/select/</code>.</p>
      
      <p>The <code>otherwise</code> element must not contain descendants in the
          <code>http://www.daisy.org/ns/z3998/authoring/features/select/</code> namespace.</p>
    </div>
    ...
    <div class="rd-section" id="prefix-decl">
      ...
      <p>
        ...
        <code>http://www.daisy.org/z3998/2012/auth/features/select/functionSets/#targetFunctionSet</code>:</p>
...
ncname := [A-Za-z][A-Za-z0-9_]*
  ...
  <div class="rd-section" id="pa-reqs">
    ...
    <div class="rd-section">
      ...
      <dl>
        ...
        <dd>
          <p>
            While traversing the document tree, each encountered <code>select</code> element
  ...
  <div id='public-components'>
    <ul>
      <li><code><a href="#z3998.select.phrase"></a></code> (Phrase variant)</li>
      <li><code><a href="#z3998.select.block"></a></code> (Block variant)</li>
      <li><code><a href="#z3998.select.selid.attrib"></a></code></li>
    </ul>  
  </div>
  
  <div class="rd-section" id="absdef">
    <?absdef src="/mod/z3998-feature-select.rng" ?>
  </div>
