...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:xi="http://www.w3.org/2001/XInclude">
  ...
  <div class="intro">
    <p>The Z39.98 SSML Integration Feature recasts a subset of the W3C <a
        href="http://www.w3.org/TR/speech-synthesis11/">Speech Synthesis Markup Language (SSML)
        Version 1.1</a> as a Feature for incorporation in Z39.98-AI Profiles.</p>
    <p>The Z39.98 SSML Integration Feature is designed to be used in authoring contexts where
    ...
    <div class="rd-section">
      ...
      <dl>
        ...
        <dd>
          ...
          <p>The <code>w</code> (word) element from the Z39.98-AI default namespace must be regarded
        ...
        <dd>
          ...
          <p>Note that the <code>expansion</code> and <code>name</code> elements when referenced
            from an <code><a href="#z3998.abbr">abbr</a></code> element have semantics that mean
