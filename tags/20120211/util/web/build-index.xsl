...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="title">Z39.98-2012 Specification Document Working area</xsl:variable>
      ...
      <body>
		...
		<div class="alert">
			<dl>
				...
				<dd>
					<p>Final Draft — <em>NISO Z39.98-2012 - Authoring and Interchange Framework for Adaptive XML Publishing</em>.</p>
		...
		<div>
        	<h2 id="auth">NISO Z39.98-2012: Authoring and Interchange Framework</h2>
