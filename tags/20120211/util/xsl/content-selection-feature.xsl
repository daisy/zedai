...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:zai="http://www.daisy.org/ns/z3998/authoring/"
    xmlns:sel="http://www.daisy.org/ns/z3998/authoring/features/select/"
    xmlns:fnk="http://www.daisy.org/z3998/2012/xsl/functions/"
    xpath-default-namespace="http://www.daisy.org/ns/z3998/authoring/" xmlns="http://www.w3.org/1999/xhtml"
    exclude-result-prefixes="xs zai sel" version="2.0">

    <!-- NB: This is NOT a standalone XSLT.
    
    This file and the included file 'content-selection-function-set-handler' is meant to be used as modules in a transformation scenario with ZedAI files 
    ...
    <xsl:function name="fnk:exprIsTrue" as="xs:boolean">
        ...
        <xsl:variable name="e.normalized" as="xs:string" select="normalize-space($expression)" />
        <xsl:choose>
