...
<xsl:stylesheet version="2.0"
	...
	<!--   Example: <define name="z3998.section.content" xml:id="z3998.section.content" xsdp:replace="z3998.section.content.xsd">  -->
	...
	<xsl:template match="include[@href='./mod/z3998-feature-mathml.rng']">
		<xsl:choose>
			<xsl:when test="$replace-mathml-include-with-dummy eq 'true'">		
				...
				<define name="z3998.Phrase.contrib.class" combine="choice">
					<ref name="math"/>
				</define>				
				<define name="z3998.Block.contrib.class" combine="choice">
					<ref name="math"/>
				</define>
			</xsl:when>
			<xsl:otherwise>
