...
import org.daisy.z3998.QNameProvider.OutputGrammar;
import org.daisy.z3998.QNameProvider.Type;
import org.daisy.z3998.ant.AntHelper;
import org.daisy.z3998.rng.model.AnyElement;
import org.daisy.z3998.rng.model.DocbookAnnotationElement;
import org.daisy.z3998.rng.model.DocbookElement;
import org.daisy.z3998.rng.model.DocbookInfoElement;
...
import org.daisy.z3998.rng.model.RNGElement;
...
public class AbstractDefExpander {	
	private static final String WWW_SCHEMA_BASE_DIR = "http://www.daisy.org/z3998/2012/schema/";
	...
	private void buildOverviewModuleRequired(RNGDocument rng, Element section)
		...
		if(req) {
			...
			para.appendChild("This module must be included in all compliant Z39.98-2012 Profiles.");
			section.appendChild(para);
		}
	}
