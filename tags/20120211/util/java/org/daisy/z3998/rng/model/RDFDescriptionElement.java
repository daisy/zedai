...
//		if(!isModuleLevel()) throw new IllegalStateException();
//		Boolean omittable;	
//		Nodes nodes = this.query(".//dcterms:requiredBy[@rdf:resource='http://www.daisy.org/z3998/2012/auth/']", Constants.namespaces);
//		if(nodes.size()==1) {
//			omittable = Boolean.TRUE;
//		}else if(nodes.size()==0) {
//			omittable = Boolean.FALSE;
...
//		Nodes deps = this.query(".//dcterms:requiredBy[not(@rdf:resource='http://www.daisy.org/z3998/2012/auth/')]", Constants.namespaces);				
