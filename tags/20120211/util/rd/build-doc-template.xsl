<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    xmlns:d="http://www.daisy.org/ns/z3998/authoring/">
    ...
    <xsl:param name="rdfa-context-uri" required="yes"/>
    ...
    <xsl:variable name="rd-summary-doc" select="document(concat('file:///',translate($rd-summary, '\\', '/')))" />
    
    <xsl:template match="d:meta[@rel='z3998:profile']">        
        <xsl:element name="meta" namespace="http://www.daisy.org/ns/z3998/authoring/">
            <xsl:attribute name="rel">z3998:profile</xsl:attribute>
    ...
    <xsl:template name="feature-rd-meta-uri">
        ...
        <xsl:element name="meta" namespace="http://www.daisy.org/ns/z3998/authoring/">
            <xsl:attribute name="rel">z3998:feature</xsl:attribute>
    ...
    <xsl:template match="d:document">
    	<xsl:copy>
    		<xsl:attribute name="profile" select="$rdfa-context-uri"/>
    		<xsl:attribute name="prefix"/>
    		<xsl:apply-templates select="@*"/>
    		<xsl:comment>define additional prefixes in the prefix attribute above or remove</xsl:comment>
